...
- **[freeBrunch's Discord Bot](https://github.com/bthomas2622/freebrunch-discord-bot)** is a Discord Bot designed to run on self hosted server (e.g. raspberry pi). It generates random Apex Legends champions and other fun stuff!
